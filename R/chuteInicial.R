chuteInicial = function(f, y, X, args, ...){
  UseMethod("chuteInicial")
}

chuteInicial.MixNormal = function(f, y, X, args){
...
chuteInicial.MoENormal = function(f, y, X, args, initGrupo = "KMeans"){
...
chuteInicial.MixT = function(f, y, X, args, initGrupo = "KMeans"){
...
chuteInicial.MoET = function(f, y, X, args, initGrupo = "KMeans"){
...
chuteInicial.MixSN = function(f, y, X, args){
  ...
  medias = estimaMedia(f, X, params, args)
...
chuteInicial.MoECenSN = function(f, y, X, args){
...
chuteInicial.MoECenST = function(f, y, X, args){
